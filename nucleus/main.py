...
#                 # Stop Flask thread if running
#                 if flask_thread and flask_thread.is_alive():
#                     print("Stopping Flask thread...")
#                     stop_event.set()
#                     flask_thread.join()
#                 break
...
#                 if user_input.lower()[1:5] == 'show':
#                     file_input = user_input.lower().split("/show")[1]
...
#                     flask_thread = threading.Thread(target=run_flask_app, args=(stop_event, file_input, ))
        ...
        try:
            ...
            if user_input.lower()[0] in "!":
                ...
                if flask_process and flask_process.is_alive():
                    print("Stopping existing Flask process...")
                    flask_process.terminate()
                    flask_process.join()

                flask_process = multiprocessing.Process(target=run_flask_app, args=(file_input,))
                flask_process.start()
